...
/usr/lib/mysql-workbench/wbcopytables --mysql-source="giftMeFive@192.168.2.99:3306" --target="giftMeFive@localhost:3306" --source-password="$arg_source_password" --target-password="$arg_target_password" --thread-count=$arg_worker_count $arg_truncate_target $arg_debug_output --table '`gift_me_five`' '`wish`' '`gift_me_five`' '`wish`' '`id`' '`id`' '`id`, `create_date`, `description`, `image`, `item`, `link`, `modify_date`, `price`, `title`, `giver_id`, `wishlist_id`' --table '`gift_me_five`' '`role`' '`gift_me_five`' '`role`' '`id`' '`id`' '`id`, `create_date`, `modify_date`, `role`' --table '`gift_me_five`' '`wishlist`' '`gift_me_five`' '`wishlist`' '`id`' '`id`' '`id`, `create_date`, `modify_date`, `title`, `unique_url_giver`, `unique_url_receiver`, `receiver_id`, `theme_id`' --table '`gift_me_five`' '`user`' '`gift_me_five`' '`user`' '`id`' '`id`' '`id`, `create_date`, `email`, `failed_logins`, `firstname`, `last_login`, `lastname`, `modify_date`, `password`, `role`' --table '`gift_me_five`' '`theme`' '`gift_me_five`' '`theme`' '`id`' '`id`' '`id`, `background_picture`, `category`, `modify_date`' --table '`gift_me_five`' '`giver_see_wishlist`' '`gift_me_five`' '`giver_see_wishlist`' '`user_id`,`wishlist_id`' '`user_id`,`wishlist_id`' '`user_id`, `wishlist_id`'
