...
CREATE TABLE IF NOT EXISTS `gift_me_five`.`theme` (
  `id` BIGINT NOT NULL,
  `backgroundPicture` VARCHAR(256) NOT NULL,
  `category` VARCHAR(256) NULL COMMENT 'defaults (spring, summer, autumn, winter)\n		',
  `modify_date` DATETIME NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `gift_me_five`.`wishlist` (
  ...
  `unique_url_giver` VARCHAR(256) NULL,
  `unique_url_receiver` VARCHAR(256) NULL,
  `create_date` DATETIME NULL,
  `modify_date` DATETIME NULL,
  `receiver_id` BIGINT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_wishlist_theme1_idx` (`theme_id` ASC),
  INDEX `fk_wishlist_user1_idx` (`receiver_id` ASC),
...
-- -----------------------------------------------------
-- Table `gift_me_five`.`giver_has_wishlist`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gift_me_five`.`giver_has_wishlist` (
